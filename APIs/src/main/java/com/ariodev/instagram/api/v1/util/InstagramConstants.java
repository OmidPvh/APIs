...
public class InstagramConstants
{
    ...
    public static String getUserAgent()
    {
        ...
        Display defaultDisplay = ((WindowManager) Instagram.getContext()
                                                           .getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();

        DisplayMetrics displayMetrics = new DisplayMetrics();
        defaultDisplay.getMetrics(displayMetrics);

        int densityDpi = Instagram.getContext()
                                  .getResources()
        ...
        String realUserAgent = String.format("Instagram 146.0.0.27.125 Android (%s/%s; %sdpi; %sx%s; %s; %s; %s; %s; en_US)", Build.VERSION.SDK_INT, Build.VERSION.RELEASE, densityDpi, widthPixels, heightPixels, MANUFACTURER, strModel, strDevice, strBoard);
    ...
    {
        Display defaultDisplay = ((Activity) Instagram.getContext()).getWindowManager()
                                                                    .getDefaultDisplay();
        DisplayMetrics displayMetrics = new DisplayMetrics();
        defaultDisplay.getMetrics(displayMetrics);
        int densityDpi = Instagram.getContext()
        ...
        return strModel != null && !strModel.isEmpty() && strManufacturer != null && !strManufacturer.isEmpty() && Build.VERSION.RELEASE != null && !strDevice.isEmpty() && strBoard != null && !strBoard.isEmpty() && !strUserAgent.contains("unknown");
    }
