...
import com.ariodev.instagram.api.v1.requests.payload.InstagramTimelineFeedResult;
...
public class InstagramTimelineFeedRequest extends InstagramRequest<InstagramTimelineFeedResult>
{
    ...
    private final String maxId = null;
    private final List<String> seen_posts = null;
